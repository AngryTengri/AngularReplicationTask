...
namespace UnityEngine.XR.OpenXR.Samples.ControllerSample
{
    public class TrackingModeOrigin : MonoBehaviour
    {
        ...
        {
            Debug.Log("Wave.OpenXR.Samples.OpenXRInput.TrackingModeOrigin TrackingOriginUpdated() " + obj != null ? obj.ToString() : "");
        ...
        {
            Debug.Log("Wave.OpenXR.Samples.OpenXRInput.TrackingModeOrigin TrackingOriginUpdated() " + mode);
            m_LastRecenteredTime = Time.time;
        }
        ...
        private void CheckUserPresence()
        {
            ...
            if (userPresence != presence)
            {
                ...
                Debug.Log("Wave.OpenXR.Samples.OpenXRInput.TrackingModeOrigin CheckUserPresence() userPresence: " + userPresence);
            }
        }
